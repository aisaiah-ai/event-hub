/**
 * Check in all fisher registrants for March Assembly.
 * Also searches RSVPs and auto-registers if only in RSVPs.
 * Run: cd functions && node scripts/checkin-fisher.js
 */
...
async function run() {
  ...
  console.log(`\nFound ${found} fisher(s), checked in ${checkedIn} new.`);
}
