  ...
  res.json({
    ...
    data: {
      ...
      endpoints: {
        ...
        images: "GET /v1/events/:eventId/images (approved only), POST /v1/events/:eventId/images (upload, pending), PATCH /v1/events/:eventId/images/:imageId (approve/reject), GET /v1/events/:eventId/images/mine, GET /v1/events/:eventId/images/review",
      },
    },
  });
});
