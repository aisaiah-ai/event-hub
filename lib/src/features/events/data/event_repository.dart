  ...
  static List<EventSession> _fallbackSessions(String eventId, {String? slug}) {
    ...
    return [
      ...
      EventSession(
        ...
        order: 2,
        startAt: DateTime.utc(2026, 3, 14, 17, 0),
        endAt: DateTime.utc(2026, 3, 14, 19, 0),
        materials: const [],
        speakerIds: const [],
      ),
      EventSession(
        ...
        order: 3,
        startAt: DateTime.utc(2026, 3, 14, 19, 0),
        endAt: DateTime.utc(2026, 3, 14, 19, 20),
        materials: const [],
        speakerIds: const [],
      ...
      EventSession(
        ...
        order: 4,
        startAt: DateTime.utc(2026, 3, 14, 19, 20),
        endAt: DateTime.utc(2026, 3, 14, 19, 40),
        materials: const [],
        speakerIds: const [],
      ),
      EventSession(
        ...
        order: 5,
        startAt: DateTime.utc(2026, 3, 14, 19, 40),
        endAt: DateTime.utc(2026, 3, 14, 19, 45),
        materials: const [],
        speakerIds: const [],
      ),
      EventSession(
        ...
        order: 6,
        startAt: DateTime.utc(2026, 3, 14, 19, 45),
      ...
      EventSession(
        ...
        endAt: DateTime.utc(2026, 3, 14, 20, 35),
        materials: const [],
        speakerIds: const [],
      ...
      EventSession(
        ...
        order: 8,
        startAt: DateTime.utc(2026, 3, 14, 20, 35),
        endAt: DateTime.utc(2026, 3, 14, 21, 10),
        materials: const [],
        speakerIds: const [],
      ...
      EventSession(
        ...
        order: 9,
        startAt: DateTime.utc(2026, 3, 14, 21, 10),
      ...
      EventSession(
        ...
        endAt: DateTime.utc(2026, 3, 14, 21, 40),
        materials: const [],
        speakerIds: const [],
      ...
      EventSession(
        ...
        order: 11,
        startAt: DateTime.utc(2026, 3, 14, 21, 40),
      ...
      EventSession(
        ...
        endAt: DateTime.utc(2026, 3, 14, 21, 55),
        materials: const [],
        speakerIds: const [],
      ),
      EventSession(
        ...
        description: 'BBS Music Ministry',
        order: 13,
        startAt: DateTime.utc(2026, 3, 14, 21, 55),
